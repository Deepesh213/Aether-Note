        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    className="opacity-50 group-hover/sidebar:opacity-100
                        transition cursor-ew-resize absolute h-full w-0.5 bg-neutral-400 dark:bg-neutral-600
                        right-0 top-0"
                />
            </aside>
            <div
                ...
                {!!params.documentId ? (
                    ...
                    <nav className="bg-transparent px-3 py-2 mt-1 w-full flex justify-between align-items">
                        {
